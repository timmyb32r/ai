...
func TestFillProbableReadings(t *testing.T) {
	p := &Processor{Unihan: testUnihan(t)}
...
func TestFillProbableReadings_CedictFallback(t *testing.T) {
	...
	p := &Processor{Cedict: cd, Unihan: testUnihan(t)}
...
func TestFillPerChar_DeterministicAndUnihan(t *testing.T) {
	...
	p := &Processor{Dictionary: dict, Unihan: testUnihan(t)} // Cedict nil
...
func TestAttachCedictMeanings(t *testing.T) {
	...
	(&Processor{}).attachCedictMeanings(words)
}

func TestFillProbableReadings_NilResolver(t *testing.T) {
	p := &Processor{Unihan: nil}
