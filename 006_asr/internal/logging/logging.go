...
// New creates a stdout logger with the given minimum level.
func New(level string) Logger {
	...
	return &productionLogger{minLevel: minLevel}
}
...
func (l *productionLogger) Debug(module, event string, kv ...interface{}) { l.log(DEBUG, module, event, kv...) }
func (l *productionLogger) Info(module, event string, kv ...interface{})  { l.log(INFO, module, event, kv...) }
func (l *productionLogger) Warn(module, event string, kv ...interface{})  { l.log(WARN, module, event, kv...) }
func (l *productionLogger) Error(module, event string, kv ...interface{}) { l.log(ERROR, module, event, kv...) }
