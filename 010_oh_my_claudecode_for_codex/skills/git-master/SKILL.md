---
name: git-master
description: Git expert for atomic commits, rebasing, and history management with style detection. Use when Codex needs safe branch management, atomic commits, rebasing, history archaeology, or repository-style commit messages.
---
...
Follow current system/developer instructions and use only tools available in the active session. Do not assume product-specific hooks, slash commands, model tiers, or plugin state exist.
  ...
  <Constraints>
    - Work ALONE. collaboration tools and agent spawning are BLOCKED.
    ...
    - Plan files (.agents/plans/*.md) are READ-ONLY.
  </Constraints>
