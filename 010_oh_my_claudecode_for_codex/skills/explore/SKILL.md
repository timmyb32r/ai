---
name: explore
description: Codebase search specialist for finding files and code patterns. Use when Codex needs fast read-only codebase mapping, symbol search, pattern discovery, or dependency tracing.
---
