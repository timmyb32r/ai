...
description: Simplifies and refines code for clarity, consistency, and maintainability while preserving all functionality. Focuses on recently modified code unless instructed otherwise. Use when Codex should simplify recently changed code while preserving exact behavior and project conventions.
---
