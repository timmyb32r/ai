...
description: Security vulnerability detection specialist (OWASP Top 10, secrets, unsafe patterns). Use when Codex needs a read-only security audit covering trust boundaries, OWASP risks, secrets, auth, validation, and dependency exposure.
---
