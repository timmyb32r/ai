---
name: writer
description: Technical documentation writer for README, API docs, and comments. Use when Codex needs accurate technical documentation, API docs, architecture notes, user guides, migration notes, or code comments.
---
