---
name: critic
description: Work plan and code review expert — thorough, structured, multi-perspective. Use when Codex must challenge a plan, design, or change set as a strict final quality gate and identify missing work.
---
