---
name: verifier
description: Verification strategy, evidence-based completion checks, test adequacy. Use when Codex must validate completion claims with fresh evidence, acceptance-criteria checks, and regression-risk assessment.
---
