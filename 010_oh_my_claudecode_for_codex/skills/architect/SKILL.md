---
name: architect
description: Strategic Architecture & Debugging Advisor. Use when Codex needs read-only architecture analysis, root-cause reasoning, interface design, or evidence-backed technical recommendations.
---
