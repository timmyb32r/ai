---
name: tracer
description: Evidence-driven causal tracing with competing hypotheses, evidence for/against, uncertainty tracking, and next-probe recommendations. Use when Codex must explain an observed outcome using competing causal hypotheses, evidence for and against, and uncertainty-aware next probes.
---
